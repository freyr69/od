...
module.exports.routes = {
  ...
  '/': 'OrgasmController.index',
  '/orgasm': 'OrgasmController.index',
  '/chastity': 'ChastityController.index',
  '/arousal': 'ArousalController.index',
  '/punishments': 'PunishmentController.index',
  '/tasks': 'TaskController.index',
  '/teases': 'TeaseController.index',
  '/stats': 'StatsController.orgasm',
  '/about': {
      view: 'home/index'
  }
